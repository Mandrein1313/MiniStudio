    ...
    codeEditor.addTextChangedListener(new TextWatcher() {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (editorManager != null &&
                    editorManager.isProgrammaticChange()) {
                return;
            }

            if (currentProject == null ||
                    currentProject.getCurrentOpenFile() == null) {
                return;
            }

            startDelayedHighlight(
                    currentProject.getCurrentOpenFile()
            );
        }
    });
}
...
private void openFile(File file) {
    ...
    if (name.endsWith(".png")
        ...
        try {
            ...
            // ✅ highlight แบบ delay
            startDelayedHighlight(file);

            codeEditor.setVisibility(
                    View.VISIBLE
            );
...
private void startDelayedHighlight(File file) {
