...
private void openFile(File file) {
    ...
    if (name.endsWith(".png") || name.endsWith(".jpg") || name.endsWith(".jpeg") || name.endsWith(".webp") || name.endsWith(".gif")) {
        // กรณีเป็นภาพ: เปิดผ่าน dialog (ตาม logic เดิมของคุณ)
        dialogManager.showImageViewerDialog(file);
    } else {
        // กรณีเป็นไฟล์โค้ด: เปิดผ่าน Editor
        try {
            // โค้ดอ่านไฟล์เดิมของคุณ
            ...
            // หากคุณมี Image Viewer แยกต่างหาก ให้ซ่อน View นั้นแล้วแสดง codeEditor
            // ตัวอย่าง: imageViewerLayout.setVisibility(View.GONE);
