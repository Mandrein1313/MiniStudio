...
public class MainActivity extends AppCompatActivity {
    ...
    // 🌟 ยุบระบบรันบิวด์บนคลาวด์เป็นเมทอดกลาง เพื่อให้รองรับการดักจับข้อความ Error แบบใหม่ทั้งปุ่มคอนโซลและเมนูบาร์ด้านบน
                ...
                new BuildTaskManager.BuildListener() {
                    ...
                    public void onBuildFinished(boolean success, String apkPath) {
                        if (success) {
                            ...
                            appendLog("🎉 [SUCCESS] บิวด์เสร็จสมบูรณ์ ได้รับไฟล์ APK แล้ว", Color.GREEN);
                        } else {
                            showToast("การรันล้มเหลว กรุณาตรวจสอบ Log");
                            
                            // 🌟 ส่วนปรับปรุง: ระบบพิมพ์เส้นกั้นแบ่งวิเคราะห์ท่อนข้อมูลดิบสีแดงเวลาระบบรันพังทันที!
                            appendLog("\n-------------------------------------------", Color.RED);
                            appendLog("🚨 [BUILD FAILED] ตรวจพบจุดพังบนระบบคลาวด์", Color.RED);
                            appendLog("-------------------------------------------\n", Color.RED);
                        }
                    }
                }
