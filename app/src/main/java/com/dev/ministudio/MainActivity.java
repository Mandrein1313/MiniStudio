...
public class MainActivity extends AppCompatActivity {
    ...
    // 🐙 เมทอดรันบิวด์บนคลาวด์: เวอร์ชันแก้ไขข้อผิดพลาดแล้ว 🌟
    private void startCloudBuildPipeline() {
        ...
        // ✅ แก้ไขจุดที่ 1: ลบ buildEnvManager ออก เพื่อให้เหลือพารามิเตอร์ 3 ตัวตรงตาม Constructor
        ...
        // ✅ แก้ไขจุดที่ 2: เปลี่ยนเป็นเรียกใช้ startCloudBuild พร้อมส่งข้อมูลที่ระบบต้องการ
        // ⚠️ อย่าลืมนำตัวแปร Token หรือ URL ของคุณมาใส่แทนข้อความด้านล่างนี้นะครับ
        String githubToken = "ใส่_GitHub_Token_ของคุณตรงนี้"; 
        String repoUrl = "ใส่_URL_Git_Repository_ของคุณตรงนี้"; 
