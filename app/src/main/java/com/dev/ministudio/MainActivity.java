...
// =============================
// Zoom System For Code Editor
// =============================
private android.view.ScaleGestureDetector scaleGestureDetector;

private float currentTextSize = 14f;

private float MIN_TEXT_SIZE = 10f;
private float MAX_TEXT_SIZE = 16f;
...
private void setupLogic() {
    ...
    // ลด redraw
    codeEditor.setOverScrollMode(View.OVER_SCROLL_NEVER);
...
private void setupCodeEditorZoom() {

    // อ่านขนาด font ปัจจุบัน
    currentTextSize =
            codeEditor.getTextSize()
    ...
    codeEditor.setOnTouchListener(
            new android.view.View.OnTouchListener() {
                ...
                public boolean onTouch(
                    ...
                    // ส่ง event เข้า detector
                    scaleGestureDetector.onTouchEvent(event);

                    // ถ้าใช้ 2 นิ้ว = Zoom
                    if (event.getPointerCount() > 1) {

                        // กัน parent scroll แย่ง event
                        if (v.getParent() != null) {
