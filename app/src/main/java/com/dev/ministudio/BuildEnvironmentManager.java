...
public class BuildEnvironmentManager {
    ...
    private void setupGradleProjectFiles(String rootPath, String projectName, String packageName, String language, int minSdk) {
        ...
        // สลับชุดข้อมูลสคริปต์ภายในแอป เพื่อให้ฝั่งระบบบิวด์คอมไพล์ซอร์สโค้ดได้ตรงตามประเภทของภาษา
        ...
        appBuildGradle.append("    implementation 'com.google.android.material:material:1.11.0'\n");
        if ("Kotlin".equals(language)) {
            appBuildGradle.append("    implementation 'androidx.core:core-ktx:1.12.0'\n"); // เสริมส่วนขยายคอร์ไลบรารีของ Kotlin
        }
        appBuildGradle.append("}\n");
