...
public class BuildEnvironmentManager {
    ...
    // 🌟 อัปเกรดให้รับตัวแปร language และ minSdk เพิ่มเข้ามาใช้งาน
    public void prepareGitHubWorkflow(String localProjectPath, String projectName, String packageName, String language, int minSdk) {
        try {
            ...
            // ลายนิ้วมือสากล Hex 64 หลัก ผ่านฉลุยชัวร์ ควบคุมความปลอดภัยสูงสุดของ Gradle 8.13
            ...
            // 🌟 ส่งค่าระดับการเลือกต่อไปจัดวางสคริปต์แบบแปรผันตามจริง
    ...
    private void setupGradleProjectFiles(String rootPath, String projectName, String packageName, String language, int minSdk) {
        ...
        // 2. สร้าง root build.gradle (เปิดทางให้ปลั๊กอิน Kotlin ทำงานร่วมด้วยเมื่อมีการเลือกเข้ามา)
        ...
        // สลับชุดข้อมูลสคริปต์ภายในแอป เพื่อให้ฝั่งระบบบิวด์คอมไพล์ซอร์สโค้ดได้ตรงตามประเภทของภาษาและโครงสร้างใหม่ที่คุณส่งมา
        ...
        // เพิ่มการแก้ปัญหา Duplicate Kotlin ตามที่คุณส่งมา
        ...
        // โครงสร้างไลบรารีใหม่ (มี JGit และ ConstraintLayout เพิ่มเข้ามา)
        ...
        // 4. สร้าง gradle.properties สำหรับเร่งความเร็ว JVM บน GitHub Actions
        ...
        // 5. ปูพื้นฐาน .gitignore ป้องกันไฟล์ขยะ แต่ปล่อยให้จัดส่งไฟล์ Wrapper .jar ได้สมบูรณ์
        ...
        // 6. เจนสคริปต์จุดชนวนและสั่งการทำงานดาวน์โหลดไฟล์ Jar
    ...
    private void generateWrapperPropertiesAndDownload(String targetRootPath) {
        ...
        // ✅ แก้ไขปัญหาอักขระหลุด (illegal escape character) เรียบร้อยแล้วที่เครื่องหมายรอบๆ CLASSPATH และ $@
